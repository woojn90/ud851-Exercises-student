...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            IntentFilter stickyFilter = new IntentFilter(Intent.ACTION_BATTERY_CHANGED);
            ...
            Intent batteryStateIntent = registerReceiver(null, stickyFilter);
            ...
            int batteryState = batteryStateIntent.getIntExtra(BatteryManager.EXTRA_STATUS, -1);
            boolean isChaging = batteryState == BatteryManager.BATTERY_STATUS_CHARGING || batteryState == BatteryManager.BATTERY_STATUS_FULL;

            // TODO (8) Update the UI using your showCharging method
            showCharging(isChaging);
        }
