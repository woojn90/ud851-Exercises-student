...
public class NotificationUtils {
    ...
    public static void remindUserBecauseCharging(Context context) {
        // COMPLETE (8) In the remindUser method use NotificationCompat.Builder to create a notification
        // that:
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setAutoCancel(true);
        // COMPLETE (9) If the build version is greater than JELLY_BEAN, set the notification's priority
        // to PRIORITY_HIGH.
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN){
            builder.setPriority(Notification.PRIORITY_HIGH);
        }
        // COMPLETE (11) Get a NotificationManager, using context.getSystemService(Context.NOTIFICATION_SERVICE);
