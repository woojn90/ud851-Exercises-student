...
public class MainActivity extends AppCompatActivity implements
    ...
    ChargingBroadcastReceiver mChargReceiver;
    IntentFilter mChagIntentFilter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // and an IntentFilter
        mChargReceiver = new ChargingBroadcastReceiver();
        mChagIntentFilter = new IntentFilter();
        ...
        mChagIntentFilter.addAction(Intent.ACTION_POWER_CONNECTED);
        mChagIntentFilter.addAction(Intent.ACTION_POWER_DISCONNECTED);
    }
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mChargReceiver, mChagIntentFilter);
    }
    ...
    protected void onPause() {
        super.onPause();
        unregisterReceiver(mChargReceiver);
    }
