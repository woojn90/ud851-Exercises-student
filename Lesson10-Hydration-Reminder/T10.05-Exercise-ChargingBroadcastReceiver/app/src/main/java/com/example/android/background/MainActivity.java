...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETE (5) Create and instantiate a new instance variable for your ChargingBroadcastReceiver
        // and an IntentFilter
        mChargingIntentFilter = new IntentFilter();
        // COMPLETE (6) Call the addAction method on your intent filter and add Intent.ACTION_POWER_CONNECTED
    ...
    // COMPLETE (7) Override onResume and setup your broadcast receiver. Do this by calling
    ...
    // COMPLETE (8) Override onPause and unregister your receiver using the unregisterReceiver method
    @Override
    ...
    // COMPLETE (1) Create a new method called showCharging which takes a boolean. This method should
    ...
    // COMPLETE (2) Create an inner class called ChargingBroadcastReceiver that extends BroadcastReceiver
    public class ChargingBroadcastReceiver extends BroadcastReceiver {
        // COMPLETE (3) Override onReceive to get the action from the intent and see if it matches the
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // COMPLETE (4) Update the UI using the showCharging method you wrote
