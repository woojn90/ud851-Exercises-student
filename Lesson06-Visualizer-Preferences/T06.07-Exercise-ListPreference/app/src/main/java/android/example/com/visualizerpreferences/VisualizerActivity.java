...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            mVisualizerView.setColor(sharedPreferences.getString(getString(R.string.pref_color_key), getString(R.string.pref_color_red_value)));
            Log.d("Check", "getString(R.string.pref_color_key) : " + getString(R.string.pref_color_key));
            Log.d("Check", "getString(R.string.pref_color_red_value) : " + getString(R.string.pref_color_red_value));
            Log.d("Check", "sharedPreferences : " + sharedPreferences.getString(getString(R.string.pref_color_key), getString(R.string.pref_color_red_value)));
        }
    }
