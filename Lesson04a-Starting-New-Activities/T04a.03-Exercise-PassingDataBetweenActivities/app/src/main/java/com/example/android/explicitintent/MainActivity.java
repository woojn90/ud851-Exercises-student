    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // COMPLETE (1) Retrieve the text from the EditText and store it in a variable
                String sendMessage = mNameEntry.getText().toString();
                /*
                ...
                // COMPLETE (2) Use the putExtra method to put the String from the EditText in the Intent
                startChildActivityIntent.putExtra("message", sendMessage);
                /*
