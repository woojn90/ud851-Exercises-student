...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RAW_JSON = "json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETE (9) If the savedInstanceState bundle is not null, set the text of the URL and search results TextView respectively
        if(savedInstanceState != null){
            ...
            if(savedInstanceState.containsKey(SEARCH_RAW_JSON)){
                String rawJsonSearchResult = savedInstanceState.getString(SEARCH_RAW_JSON);
                mSearchResultsTextView.setText(rawJsonSearchResult);
            }
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SEARCH_RAW_JSON, rawJsonSearchResult);
    }
}