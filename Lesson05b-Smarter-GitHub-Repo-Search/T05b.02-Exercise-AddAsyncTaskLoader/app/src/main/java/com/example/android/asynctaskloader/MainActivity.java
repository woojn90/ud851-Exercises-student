...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final int GITHUB_SEARCH_LOADER = 7;
    ...
    private void makeGithubSearchQuery() {
        ...
        if (TextUtils.isEmpty(githubQuery)) {
            mUrlDisplayTextView.setText("No input query");
            return;
        }
    ...
    // Within onCreateLoader
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            // Within loadInBackground
                ...
                String str_url = args.getString(SEARCH_QUERY_URL_EXTRA);
                // TODO (11) If the URL is null or empty, return null
                if(str_url == null || TextUtils.isEmpty(str_url)) return null;
