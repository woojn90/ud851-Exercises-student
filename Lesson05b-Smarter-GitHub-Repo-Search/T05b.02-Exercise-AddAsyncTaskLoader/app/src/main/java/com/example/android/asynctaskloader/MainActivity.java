...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(jjunest,"===this is onCreate() ");
        ...
        if(savedInstanceState== null){
            Log.d(jjunest,"===there are no savedInstance, so the resul is from loadmanager");
        }
        if (savedInstanceState != null) {
            Log.d(jjunest,"===this is savedInstance, so the resuls are from savedinstance");
    ...
    private void makeGithubSearchQuery() {
        ...
        if (githubSearchLoader == null) {
            Log.d(jjunest,"===when optionitem clicked , this is githubSearchLoader is null -> initLoader");
            loaderManager.initLoader(GITHUB_SEARCH_LOADER, queryBundle, this);
        } else {
            Log.d(jjunest,"===when optionitem clicked , this is githubSearchLoader is not null ->restart");
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        Log.d(jjunest,"===this is onCreateLoader() new AsyncTaskLoader Created()");
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            protected void onStartLoading() {
                Log.d(jjunest,"===this is onStartLoading() AsyncTaskLoader");
                // TODO (6) If args is null, return.
                if (args == null) {
                    Log.d(jjunest,"===this is in onStartLoading() but Bundle arg is null, so return null ");
                    return;
                }
                // TODO (7) Show the loading indicator
                mLoadingIndicator.setVisibility(View.VISIBLE);
                // TODO (8) Force a load
                Log.d(jjunest,"===this is in onStartLoading() but arg is not null, so call forceLoad()");
                forceLoad();
            ...
            public String loadInBackground() {
                Log.d(jjunest,"===this is loadInBackground() AsyncTaskLoader");
