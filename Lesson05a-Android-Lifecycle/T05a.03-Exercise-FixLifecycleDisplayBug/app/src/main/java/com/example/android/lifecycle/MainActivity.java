...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPLETE (1) Declare and instantiate an ArrayList of Strings called mLifecycleCallbacks
    private ArrayList<String> mLifecycleCallbacks = new ArrayList<>();
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLifecycleCallbacks.removeAll(mLifecycleCallbacks);
